...
split_dfm <- function(dfm, n_train){
  ...
  testing_set <- quanteda::dfm_subset(dfm, !quanteda::docnames(dfm) %in% quanteda::docnames(training_set))
  # dfm[setdiff(quanteda::docnames(dfm), quanteda::docnames(training_set))]
